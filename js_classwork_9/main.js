...
for (let i = 0; i < simpsons.length; i++){
    ...
    divName.innerText = simpsons[i].name;

    let divSurname = document.createElement('div');
    divSurname.innerText = simpsons[i].surname;

    let divAge = document.createElement('div');
    divAge.innerText = simpsons[i].age;

    let divInfo = document.createElement('div');
    divInfo.innerText = simpsons[i].info;

    let divImg = document.createElement('img');
    divImg.src = simpsons[i].photo;

    div.append(divName, divSurname, divAge, divInfo, divImg);
...
for (let i = 0; i < coursesArray.length; i++){
    ...
    divMonthDuration.innerText = coursesArray[i].monthDuration;
    ...
    divHourDuration.innerText = coursesArray[i].hourDuration;
    divHourDuration.style.border = '1px solid black';
    div.appendChild(divHourDuration);

    divWrapper.append(divMonthDuration, divHourDuration);
    divWrapper.style.display = 'flex';
    divWrapper.style.columnGap = '10px'
    ...
    for (let j = 0; j < coursesArray[i].modules.length; j++){
        ...
        liModules.style.border = '1px solid black';
        liModules.style.margin = '5px';
        liModules.innerText = coursesArray[i].modules[j];
